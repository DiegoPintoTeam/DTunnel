...
import Table, { TableItem } from './components/table.js?v=8';
...
import ModalConfigForm from './modals/config.js?v=2';
...
document.querySelector('.import-config').onclick = () => {
    const modal = new ConfigImportModal(categories, ConfigImport.create());
...
const getConfigAndCategory = async () => {
    ...
    const limit = pagination.limit ? pagination.limit : 200;
